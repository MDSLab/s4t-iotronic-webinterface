	...
	<section>
		...
		<div class="row">
			<div class="large-12 columns">
				<button id="create-project" class="button small radius" style="font-size:1.0rem; color:#fff; float:right;" onclick="loading();">Register</button>
			</div>
		</div>
	</section>
	<fieldset>
...
<div id="modal-update-project" class="reveal-modal small" data-reveal>
	<section>
		...
		<div class="row">
			<div class="large-12 columns">
				<button id="update-project" class="button small radius" style="font-size:1.0rem; color:#fff; float:right;" onclick="loading();">Update</button>
			</div>
		</div>
	</section>
	<fieldset>
...
<div id="modal-delete-project" class="reveal-modal small" data-reveal>
	<section>
		...
		<div class="row">
			<div class="large-12 columns">
				<button id="unregister-project" class="button small radius" style="font-size:1.0rem; color:#fff; float:right;" onclick="loading();">
					Unregister
				</button>
			</div>
		</div>
